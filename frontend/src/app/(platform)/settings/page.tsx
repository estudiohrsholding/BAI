  ...
  if (isLoading) {
    return (
        <div className="space-y-6">
          ...
          <div className="rounded-xl border border-slate-800 bg-slate-900/80 backdrop-blur p-6 shadow-lg">
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <span className="rounded-full bg-violet-500/20 border border-violet-500/30 px-3 py-1 text-sm font-medium text-violet-400 capitalize">
          ...
          {isAdmin && (
            <div className="rounded-xl border border-violet-500/30 bg-gradient-to-br from-violet-500/10 to-fuchsia-500/10 p-6 shadow-lg backdrop-blur">
              ...
              {/* API Keys Card */}
              <div className="rounded-xl border border-slate-800 bg-slate-900/80 backdrop-blur p-6 shadow-lg">
                <h3 className="mb-4 text-base font-semibold text-white">API Keys</h3>
                <div className="space-y-4">
                  <div>
                    <label className="block text-sm font-medium text-slate-300 mb-2">
                    ...
                    <input
                      type="password"
                      defaultValue="••••••••••••••••"
                      className="w-full rounded-md border border-slate-700 bg-slate-800 px-3 py-2 font-mono text-sm text-slate-300 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-violet-500"
                    />
                    <p className="mt-1 text-xs text-slate-500">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <input
                  type="checkbox"
                  defaultChecked
                  className="h-4 w-4 rounded border-slate-700 bg-slate-800 text-violet-600 focus:ring-violet-500 focus:ring-offset-slate-900"
                />
              </div>
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-sm font-medium text-white">Workflow Alerts</h3>
                  <p className="text-xs text-slate-500">Get notified when workflows complete</p>
                </div>
                <input
                  type="checkbox"
                  defaultChecked
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-slate-500">Platform and security updates</p>
                </div>
                <input
                  type="checkbox"
                  className="h-4 w-4 rounded border-slate-700 bg-slate-800 text-violet-600 focus:ring-violet-500 focus:ring-offset-slate-900"
